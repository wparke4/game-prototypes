...
const fetchGameData = async () => {
    //we are setting the data retuned equal to gridSwapManager
...
const handleUpdates = (payload) => {
 ...
 // Listen to updates
supabase
    .channel('gridSwapManager:*')
    .on('postgres_changes', { event: 'UPDATE', schema: 'public', table: 'gridSwapManager' }, handleUpdates)
    .subscribe()
